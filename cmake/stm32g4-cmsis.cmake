...
function(_stm43g4_stlink_variables)
...
function(stm43g4_add_stlink_targets)
    if(TARGET st-flash-erase)
        message(WARNING "stm43g4_add_stlink_targets already called, ignoring.")
        return()
    endif()
